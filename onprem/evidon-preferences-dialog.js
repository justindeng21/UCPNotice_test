(function() {
    ...
    var ce = function() {
        ...
        this._createVendorContent = function(cI, cF) {
            ...
            if (a9.consentDetailVendors && !a9._isConsentGiven() && a9.isGPCApply() && cF.dataSharing === 1) {
                var cH = new cu("vendor-" + cI.id + "-toggle",function(cK) {
    ...
    var cd = function() {
        ...
        this._createDesktop = function() {
            ...
            var cS = this._overlay = l("div", {
                id: bd,
                className: g[bd],
                css: ci[bd]
            }, document.body);
            var cO = this._navContainer = l("div", {
                id: a6,
                className: g[a6],
                css: ci[a6]
            }, cS);
            var cV = a9._getStyleValue(ci[a6], "width");
            var cH = a9._getStyleValue(ci[bd], "padding");
            var cL = a9.isGPCApply ? a9.isGPCApply() : false;
            var cM = 200;
            if (cV) {
                cV = parseInt(cV, 10);
                if (!isNaN(cV)) {
            ...
            cQ.innerText = "Privacy dialog navigation";
            this._navList = l("ul", {
                id: a8,
            ...
            if (cL) {
                ...
                var cT = ci[bs].split(";");
                var cU = [];
                cT.forEach(function(cZ) {
                    if (cZ && cZ.indexOf("margin") == -1) {
                        cU.push(cZ)
                    }
                });
                var cK = cU.join(";");
            ...
            var cN = parseInt(cD.marginTop, 10) + parseInt(cD.marginBottom, 10);
            if (!isNaN(cN)) {
                cF += cN
            }
            ...
            cS.appendChild(this._createWithdrawBackground());
            cS.appendChild(this._createDesktopWithdrawOverlay());
            cY.appendChild(this._createCloseIcon());
            if (this.TAB_ID) {
        ...
        this._createCloseIcon = function() {
            var cE = this;
            var cD = a9._createCloseIcon(ci[h], h, g[h]);
            cD.onclick = function() {
                cE.close()
            }
            ;
        ...
        this._createWithdrawCloseIcon = function() {
            var cE = this;
            var cD = a9._createCloseIcon(ci[h], h, g[h], undefined, undefined, "close withdraw dialog");
