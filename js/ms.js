(function() {
    ...
    var a = {
        15633: {
            ...
            cEstnl: false,
            dataSharing: true,
            catId: [1, 25, 21, 15, 11, 12, 8, 2, 26, 22, 16, 13, 9, 3, 14, 28]
        },
        15638: {
            cName: "Functional",
            cEstnl: true,
            dataSharing: false,
            catId: [7, 29, 30, 17, 31, 27, 23, 24, 20, 10, 5]
        }
    };
    var b = {
        1: {
...
(function() {
    ...
    ;
    aH.prototype._createCloseIcon = function(a3, aV, aP, a0, a1, aM) {
        var aQ = null
          , aR = document;
        ...
        if (typeof SVGRect !== "undefined") {
            ...
            aQ.setAttribute("aria-label", aM ? aM : "close dialog");
            var aS = aR.createElementNS(aX, "g");
            aS.id = "__ghostery-close-icon-svg";
        ...
        aN.id = aV;
        aN.setAttribute("aria-label", aM ? aM : "close dialog");
