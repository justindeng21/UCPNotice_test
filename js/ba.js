var BAP =
  ...
  (function() {
    ...
    var API = {},
      ...
      DOMAIN_ROOT = protocol + "c.evidon.com",
      DOMAIN_CSS = DOMAIN_ROOT + "/a/",
      DOMAIN_JSON = DOMAIN_ROOT + "/a/",
      DOMAIN_INFO_L3 = "https://l3.evidon.com/",
    ...
    */
    ...
    function copyOptions(pageId, nid) {
      try {
        ...
        mp["adv_logo_" + country] &&
          (BAP.options[pageId].advLogo = mp["adv_logo_" + country].replace("http:","https:"));
        ...
        // add in the L3 url overrides here
        var customoptout = mp.hasOwnProperty('custom_optout_' + country) ? mp['custom_optout_' + country] : (cud.hasOwnProperty('custom_optout') ? cud.custom_optout : null);
        if (customoptout) {
            BAP.options[pageId].customL3 = customoptout.desktop;
        }
        else {
    ...
    function moreInfoHref(pageId) {
      var vi,
        key,
        p = [],
        mi = DOMAIN_INFO_L3 + "ad/" + nids[pageId] + "/" + countryId;
      if (BAP.options[pageId].coid == 321) {
        // custom ownerIQ opt-out page.
        mi = "https://owneriq.evidon.com";
      } 
    else if (BAP.options[pageId].hasOwnProperty('customL3') && BAP.options[pageId].customL3) {
    ...
    function proximityDetection(pxId, spotWidth, spotHeight, px) {
      ...
      for (key in matches) {
        d = Math.abs(pxId - key);
        //if (d > 50) { continue; }
        if ((!dist || d < dist) && !matches[key].notice) {
          dist = d;
          cm = matches[key];
        }
    ...
    function noticeMode(pageId) {
      ...
      if (
        ifr &&
        (frameSize()[0] === spotHeight && frameSize()[1] === spotWidth)
      ) {
    ...
    function updateL2(pageId) {
      var popup = $("bap-notice-" + pageId),
        l;
      if (BAP.options[pageId].positionHorizontal() === "right") {
        if (!BAP.options[pageId].vpaid && (BAP.options[pageId].ad.nodeName !== "EXACT-FRAME")) {
    ...
    function createPopupLayer(pageId) {
      ...
      if (reg === 1) {
        ...
        noticeHTML =
          '<div id="bap-notice-' +
          pageId +
          '" class="bap1 bap-notice" style="' +
          qw +
          ";display:none;" +
          z +
          '"><div class="bap-div"><div class="bap-close" onclick="BAP.toggle(' +
          pageId +
          ');return false;">' +
          sc +
          '</div><div class="bap-img-container">' +
          (BAP.options[pageId].advLogo
            ? BAP.options[pageId].advLink && !BAP.options[pageId].hideCustom
              ? '<a class="bap-blue" target="_blank" href="' +
          ...
          "</div><p>" +
          generic_msg +
          '</p><div class="bap-link-div"' +
          lds +
          '><a class="bap-blue" href="about:blank" id="bap-link-1-' +
          pageId +
          ...
          (BAP.options[pageId].hideWhatIs
            ...
            : '<div class="bap-link-div"' +
              lds +
              '><a class="bap-blue" href="about:blank" id="bap-link-2-' +
              pageId +
              '" target="_blank" onclick="BAP.action(\'' +
              pageId +
              ...
              sw +
              " &raquo;</a></div>");
        if (!BAP.options[pageId].hideCustom) {
          if (BAP.options[pageId].advLink && BAP.options[pageId].advMessage) {
            noticeHTML +=
              '<div class="bap-link-div"' +
              lds +
              '><a class="bap-blue" target="_blank" href="' +
              ...
              pageId +
              "', 'A');\">" +
              BAP.options[pageId].advMessage +
              " &raquo;</a></div>";
          } else if (BAP.options[pageId].advMessage) {
            noticeHTML +=
              '<div class="bap-link-div"' +
              lds +
              ">" +
        ...
        noticeHTML +=
          '<div class="bap-link-div"' + lds + ">" + se + "</div></div></div>";
      } else if (reg === 2) {
        noticeHTML =
          '<div id="bap-notice-' +
          pageId +
          '" class="bap2 bap-notice" style="width:156px;display:none;' +
          z +
          '"><div class="bap-div"><div class="bap-close" onclick="BAP.toggle(BAP.$(\'bap-notice-' +
          pageId +
          "'));return false;\">" +
          sc +
          '</div><div class="bap-img-container">' +
          ...
          "</div><p>" +
          generic_msg +
          '</p><div class="bap-link-div"><a class="bap-blue" href="about:blank" id="bap-link-1-' +
          pageId +
          '" target="_blank" onclick="BAP.action(\'' +
          pageId +
          "', 'M');\" onmouseover=\"BAP.moreInfoLink('" +
          ...
          (BAP.options[pageId].hideWhatIs
            ? ""
            : '<div class="bap-link-div"><a class="bap-blue" href="about:blank" id="bap-link-2-' +
              pageId +
              '" target="_blank" onclick="BAP.action(\'' +
              pageId +
              "', 'B');\" onmouseover=\"BAP.iabLink('" +
        ...
        if (!BAP.options[pageId].hideCustom) {
          if (BAP.options[pageId].advLink && BAP.options[pageId].advMessage) {
            noticeHTML +=
              '<div class="bap-link-div"><a class="bap-blue" target="_blank" href="' +
              BAP.options[pageId].advLink +
              '" onclick="BAP.action(\'' +
              pageId +
              "', 'A');\">" +
        ...
        noticeHTML += '<div class="bap-link-div">' + se + "</div></div></div>";
      } else if (reg === 5) {
        noticeHTML +=
          '<div id="bap-notice-' +
          pageId +
          '" class="bap5 bap-notice" style="display:none;' +
          z +
          '"><div class="bap-div"><div class="bap-close" onclick="BAP.toggle(BAP.$(\'bap-notice-' +
          pageId +
          "'));return false;\">" +
          ...
          "</div><p>" +
          generic_msg +
          ' <a class="bap-blue-link" href="about:blank" id="bap-link-1-' +
          pageId +
          '" target="_blank" onclick="BAP.action(\'' +
          pageId +
          "', 'M');\" onmouseover=\"BAP.link('bap-link-1-" +
          pageId +
          "', '" +
          DOMAIN_INFO_L3 + 
          'ad/' + 
        ...
        lds = browser.QuirksMode
          ...
          : "";
        // push everything down for single link
        if (BAP.options[pageId].hideCustom && BAP.options[pageId].hideWhatIs) {
          noticeHTML +=
            "<style>#bap-first-link-div { padding-top:45px !important; }</style>";
        } else if (
          BAP.options[pageId].hideCustom ||
          BAP.options[pageId].hideWhatIs
        ) {
          noticeHTML +=
            "<style>#bap-first-link-div { margin-top: 20px !important; }</style>";
        }
        noticeHTML +=
          '<div id="bap-notice-' +
          pageId +
          '" class="bap6 bap-notice" style="display:none;' +
          qw +
          z +
          '"><div class="bap-div"><div id="bap-gradient-1" class="bap-gradient"><div id="bap-first-link-div" class="bap-link-div"' +
          lds +
          '><a class="bap-blue" href="about:blank" id="bap-link-1-' +
          pageId +
          '" target="_blank" onclick="BAP.action(\'' +
          ...
          sm +
          " &raquo;</a></div>";
        noticeHTML += BAP.options[pageId].hideWhatIs
          ? ""
          : '<div class="bap-link-div"' +
            lds +
            '><a class="bap-blue" href="about:blank" id="bap-link-2-' +
        ...
        noticeHTML +=
          ...
          ">" +
          se +
          '</div></div><div id="bap-gradient-2" class="bap-gradient"><div class="bap-close" onclick="BAP.toggle(BAP.$(\'bap-notice-' +
          pageId +
          "'));return false;\">" +
          sc +
          '</div><div class="bap-img-container">' +
    ...
    function _offset(elem) {
      ...
      var clientTop = docElem.clientTop || (browser.QuirksMode ? body.clientTop : 0) || 0,
        ...
        scrollTop = win.pageYOffset || (_boxModel && docElem.scrollTop) ||  (window.pageYOffset || 0),
        scrollLeft = win.pageXOffset || (_boxModel && docElem.scrollLeft) ||  (window.pageXOffset || 0),
